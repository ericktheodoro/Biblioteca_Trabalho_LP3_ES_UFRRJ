...
public class FXMLAnchorPaneProcessosVendasController implements Initializable {
    ...
    @FXML
    private TableColumn<Venda, Venda> tableColumnVendaUsuario;
    @FXML
    ...
    @FXML
    private Label labelVendaUsuario;
    ...
    public void carregarTableViewVendas() {
        ...
        tableColumnVendaUsuario.setCellValueFactory(new PropertyValueFactory<>("usuario"));
