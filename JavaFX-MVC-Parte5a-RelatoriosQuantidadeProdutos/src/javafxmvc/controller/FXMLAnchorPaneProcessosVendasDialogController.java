...
public class FXMLAnchorPaneProcessosVendasDialogController implements Initializable {
    ...
    @FXML
    private ComboBox comboBoxVendaUsuario;
    @FXML
    ...
    public void carregarComboBoxUsuarios() {
        ...
        comboBoxVendaUsuario.setItems(observableListUsuarios);

        //Como não será possível alterar uma Venda, não precisaremos implementar a seleção do usuario (caso seja uma alteração de venda)
    }
    ...
    public void handleButtonConfirmar() {
        if (validarEntradaDeDados()) {
            venda.setUsuario((Usuario) comboBoxVendaUsuario.getSelectionModel().getSelectedItem());
    ...
    private boolean validarEntradaDeDados() {
        ...
        if (comboBoxVendaUsuario.getSelectionModel().getSelectedItem() == null) {
