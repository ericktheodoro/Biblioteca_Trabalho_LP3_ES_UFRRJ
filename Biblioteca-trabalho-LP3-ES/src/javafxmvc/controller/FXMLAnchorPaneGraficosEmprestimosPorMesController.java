...
public class FXMLAnchorPaneGraficosEmprestimosPorMesController implements Initializable {
    ...
    public void initialize(URL url, ResourceBundle rb) {
     ...
     /*   // Obtém an array com nomes dos meses em Inglês.
        ...
        Map<Integer, ArrayList> dados = emprestimoDAO.listarQuantidadeEmprestimosPorMes();
